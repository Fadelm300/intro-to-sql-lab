...
SELECT countrycode
  FROM countrylanguages 
    WHERE language ='Italian' 
       AND countrycode
             NOT IN (SELECT countrycode FROM countrylanguages WHERE language !='Italian' );
...
-- Write SQL query here
  ...
  SELECT cities.name 
   FROM cities , countries 
     WHERE cities.countrycode = countries.code AND cities.name LIKE 'Serra%' AND continent = 'South America';
